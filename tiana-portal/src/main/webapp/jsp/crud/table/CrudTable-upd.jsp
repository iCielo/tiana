...
<script type="text/javascript">
	$(function() {
		$("#form").validator({
			fields : {
				tableName : "required;length(~20);remote[${CP}/crud/table.do?method=chkTableName, id]",
	...
	<article class="page-container">
		<form action="" method="post" class="form form-horizontal" id="form">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" placeholder="请输入菜单名称" type="text" id="menuName" name="menuName"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" placeholder="请输入模块名称" type="text" id="moduleName" name="moduleName"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="moduleCode" name="moduleCode" readonly="readonly" value="${entity.moduleCode }">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>实体类名：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="entity" name="entity" readonly="readonly" value="${entity.entity }">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>包路径名：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="entityPackage" name="entityPackage" readonly="readonly"
							value="${entity.entity }">
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="controller" name="controller" readonly="readonly" value="${entity.controller }">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>包路径名：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="controllerPackage" name="controllerPackage" readonly="readonly"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="service" name="service" readonly="readonly" value="${entity.service }">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>包路径名：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="servicePackage" name="servicePackage" readonly="readonly"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="controllerUrl" name="controllerUrl" readonly="readonly"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="mybatisXml" name="mybatisXml" readonly="readonly"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="listUrl" name="listUrl" readonly="readonly" value="${entity.listUrl }">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>列表&nbsp;JSP：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="listJsp" name="listJsp" readonly="readonly" value="${entity.listJsp }">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>新增映射：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="addUrl" name="addUrl" readonly="readonly" value="${entity.addUrl }">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>新增&nbsp;JSP：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="addJsp" name="addJsp" readonly="readonly" value="${entity.addJsp }">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>修改映射：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="updUrl" name="updUrl" readonly="readonly" value="${entity.updUrl }">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>修改&nbsp;JSP：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" id="updJsp" name="updJsp" readonly="readonly" value="${entity.updJsp }">
				</div>
			</div>
			<div class="row cl">
